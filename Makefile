...
clean: release-clean debug-clean  FORCE
	-$(DEL_FILE) /home/ubunrumxe/ignitioncoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) /home/ubunrumxe/ignitioncoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
	-$(DEL_FILE) /home/ubunrumxe/ignitioncoin/src/secp256k1/src/libsecp256k1_la-secp256k1.o;
	-$(DEL_FILE) cd
	-$(DEL_FILE) /home/ubunrumxe/ignitioncoin/src/secp256k1;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) /home/ubunrumxe/ignitioncoin/ignition-qt_plugin_import.cpp .qmake.stash

/home/ubunrumxe/ignitioncoin/src/leveldb/libleveldb.a: FORCE
	cd /home/ubunrumxe/ignitioncoin/src/leveldb && CC=i686-w64-mingw32.static-gcc CXX=i686-w64-mingw32.static-g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-fno-keep-inline-dllexport -pipe -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && i686-w64-mingw32.static-ranlib /home/ubunrumxe/ignitioncoin/src/leveldb/libleveldb.a && i686-w64-mingw32.static-ranlib /home/ubunrumxe/ignitioncoin/src/leveldb/libmemenv.a

/home/ubunrumxe/ignitioncoin/src/secp256k1/src/libsecp256k1_la-secp256k1.o: FORCE
	cd /home/ubunrumxe/ignitioncoin/src/secp256k1 && ./autogen.sh && ./configure --enable-module-recovery --with-bignum=no --host=i686-w64-mingw32.static CC=i686-w64-mingw32.static-gcc && CXX=i686-w64-mingw32.static-g++ $(MAKE) OPT="-fno-keep-inline-dllexport -pipe -D_FORTIFY_SOURCE=2 -O2"
