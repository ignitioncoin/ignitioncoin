...
#define MASTERNODE_WINNER_AGE_BYPASS_DELAY      (5*60) // 5 hours between median time and current time
...
//
// The Masternode Class. For managing the darksend process. It contains the input of the 500 IC, signature to prove
