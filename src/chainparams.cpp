...
public:
	CMainParams() {
		...
		vSeeds.push_back(CDNSSeedData("209.250.225.55", "209.250.225.55"));
		...
		vSeeds.push_back(CDNSSeedData("62.171.128.147", "62.171.128.147"));
		...
		vSeeds.push_back(CDNSSeedData("87.225.105.6", "87.225.105.6"));
