...
private slots:
    ...
    QString BuyHM(QString OrderType, double Quantity, double Rate);
    QString SellHM(QString OrderType, double Quantity, double Rate);
